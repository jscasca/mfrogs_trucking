...
#################
$subtitle = "Unions";
$description = "Add the name of the union that will be available for your drivers";
...
function validateForm(){
	...
	if(document.getElementById('unionName').value.length==0){
	...
	<div id="middle">
		...
		<div id="center-column">
		  ...
		  <!--<div class="select-bar">
			...
			<div class="table">
			<form id="formValidate" name="formValidate" method="POST" action="submitUnion.php" onsubmit="return validateForm();" >
				<img src="/trucking/img/bg-th-left.gif" width="8" height="7" alt="" class="left" />
				<img src="/trucking/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">New Union</th>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Number:</strong></td>
						<td class="last"><input type="text" class="text" id='unionName' name='unionName'/></td>
					</tr>
					<tr class="bg">
						<td class="first"><strong>Union Name:</strong></td>
						<td class="last"><input type="text" class="text" id='unionDescription' name='unionDescription' /></td>
					</tr>
				</table>
				<table>
				<tr>
			...
			$queryTerms = "select * from worker_union";
			...
			if($numTerms>0)
			{
				...
				echo "<tr>
						<th class='first' width='177'>Union Number</th>
						<th>Description (Union Name)</th>
						<th>Edit</th>
				...
				while($term = mysql_fetch_assoc($terms))
				{
					...
					echo "
						<td class='first style2'>".$term['unionName']."</td>
						<td class='first style2'>".$term['unionDescription']."</td>
						<td></td>
						<td></td>";
