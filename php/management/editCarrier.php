...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="table">
			<form id="formValidate" name="formValidate" method="POST" action="submitEditCarrier.php?i=<?echo$_GET['i'];?>" onsubmit="return validateForm();" >
				<img src="/trucking/img/bg-th-left.gif" width="8" height="7" alt="" class="left" />
				<img src="/trucking/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">Edit Carrier</th>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Name:</strong></td>
						<td class="last"><input <?if(isset($lastVal['carrierName']))echo"value='".$lastVal['carrierName']."'";?> type="text" class="text" id='carrierName' name='carrierName'/></td>
					</tr>
					<tr class="bg">
						<td class="first"><strong>e-mail:</strong></td>
						<td class="last"><input <?if(isset($lastVal['carrierMail']))echo"value='".$lastVal['carrierMail']."'";?> type="text" class="text" id='carrierMail' name='carrierMail' /></td>
					</tr>
				</table>
				<table>
				<tr>
