...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			...
			<div class="table">
			<form id="formValidate" name="formValidate" method="POST" action="submitShellProjectToJob.php" onsubmit="return validateForm();" >
				<img src="/trucking/img/bg-th-left.gif" width="8" height="7" alt="" class="left" />
				<img src="/trucking/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">ShellProject to Job</th>
					</tr>
					<tr class="bg">
						<td class="first" width="172"><strong>Project Number:</strong><span style="color:red;">*</span></td>
						<td class="last"><input type="text" id='projectId' name='projectId' readonly="readonly" value="<?echo$next_inc;?>" /></td>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Project Name:</strong><span style="color:red;">*</span></td>
						<td class="last"><input type="text" id='projectName' name='projectName' readonly="readonly" value="<?echo$projectInfo['fakeprojectName'];?>" /></td>
					</tr>
					<input type="hidden" id='fakeprojectId' name='fakeprojectId' value="<?echo$fakeprojectId;?>" />
					<tr class="bg">
					...
					<tr>
						...
						<td class="last"><input type="text" id='addressLine1' name='addressLine1' readonly="readonly" value="<?echo$projectInfo2['addressLine1'];?>"/></td>
					</tr>
					<tr class="bg">
						<td class="first" width="172"><strong>Line 2:</strong></td>
						<td class="last"><input type="text" id='addressLine2' name='addressLine2'  readonly="readonly" value="<?echo$projectInfo2['addressLine2'];?>"/></td>
					</tr>
					<tr>
						<td class="first"><strong>City:</strong></td>
						<td class="last"><input type="text" id='addressCity' name='addressCity'  readonly="readonly" value="<?echo$projectInfo2['addressCity'];?>"/></td>
					</tr>
					
					<input type="hidden" id='addressId' name='addressId' value="<?echo$projectInfo2['addressId'];?>" />
					
					<tr class="bg">
						<td class="first" width="172"><strong>State:</strong></td>
						<td class="last">
						<?
						$queryState = "select * from state where stateId='".$projectInfo2['addressState'].
						"'";
						$states = mysql_query($queryState,$conexion);
					...
					<tr>
						...
						<td class="last"><input type="text" id='addressZip' name='addressZip'  readonly="readonly" value="<?echo$projectInfo2['addressZip'];?>"/></td>
					</tr>
					<tr class="bg">
						<td class="first" width="172"><strong>P.O.Box:</strong></td>
						<td class="last"><input type="text" id='addressPOBox' name='addressPOBox'  readonly="readonly" value="<?echo$projectInfo2['addressPOBox'];?>"/></td>
					</tr>
					<tr>
					...
					<tr class='bg'>
						...
						<td class="last">
						<?
						$queryState = "select * from customer where customerId=".$projectInfo['customerId'];
						$states = mysql_query($queryState,$conexion);
						$state=mysql_fetch_assoc($states);
