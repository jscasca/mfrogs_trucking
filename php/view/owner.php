...
#################
$subtitle = "Owner";
$description = "Add a new Owner for the last project Inserted. Values marked with <span style='color:red;'>*</span> are mandatory.";
...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			...
			<div class="table">
			<form id="formValidate" name="formValidate" method="POST" action="submitOwner.php?i=<?echo$_GET['i']?>" onsubmit="return validateForm();" >
				<img src="/trucking/img/bg-th-left.gif" width="8" height="7" alt="" class="left" />
				<img src="/trucking/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">New Owner</th>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Name:</strong><span style="color:red;">*</span></td>
						<td class="last"><input type="text" class="text" id='ownerName' name='ownerName'/></td>
					</tr>
					<tr class="bg">
