...
#################
$subtitle = "Vendor";
$description = "Add a new vendor. Vendors englobe suppliers that can be distributed around the country. Values marked with <span style='color:red;'>*</span> are mandatory.";
...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			...
			<div class="table">
			<form id="formValidate" name="formValidate" method="POST" action="submitVendor.php" onsubmit="return validateForm();" >
				<img src="/trucking/img/bg-th-left.gif" width="8" height="7" alt="" class="left" />
				<img src="/trucking/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
					...
					<tr>
						...
						<td class="last"><input type="text" class="text" id='vendorName' name='vendorName'/></td>
					</tr>
					<tr class="bg">
						<td class="first"><strong>Additional Information:</strong></td>
						<td class="last"><textarea rows="2" cols="43" class="text" id='vendorInfo' name='vendorInfo' /></textarea></td>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Commentaries:</strong></td>
						<td class="last"><input type="text" class="text" id='vendorComment' name='vendorComment'/></td>
					</tr>
					<tr class="bg">
						<td class="first"><strong>Tel:</strong></td>
						<td class="last"><input type="text" class="text" id='vendorTel' name='vendorTel' /></td>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Fax:</strong></td>
						<td class="last"><input type="text" class="text" id='vendorFax' name='vendorFax'/></td>
					</tr>
					<tr class="bg">
			...
			$queryContacts = "select * from vendor order by vendorId desc limit 5";
			...
			if($numTerms>0)
			{
				...
				while($term = mysql_fetch_assoc($terms))
				{
					...
					echo "
						...
						<td><a href='/trucking/php/new/newSupplier.php?i=".$term['vendorId']."'><img src='/trucking/img/95.png' width='20' height='20' /></a></td>
						<td><a href='/trucking/php/view/viewVendor.php?i=".$term['vendorId']."'><img src='/trucking/img/16.png' width='20' height='20' /></a></td>
						<td><a href='/trucking/php/edit/editVendor.php?i=".$term['vendorId']."'><img src='/trucking/img/13.png' width='20' height='20' /></a></td>
						<td class='last'><a onclick=\"return confirm('Are you sure you want to delete ".$term['vendorName']."?');\" href='deleteVendor.php?i=".$term['vendorId']."'><img src='/trucking/img/118.png' width='20' height='20' /></a></td>
					</tr>";
				}
