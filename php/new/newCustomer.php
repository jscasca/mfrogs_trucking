...
#################
$subtitle = "Customer";
$description = "Add a new customer. Values marked with <span style='color:red;'>*</span> are mandatory.";
...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			...
			<div class="table">
			<form id="formValidate" name="formValidate" method="POST" action="submitCustomer.php" onsubmit="return validateForm();" >
				<img src="/trucking/img/bg-th-left.gif" width="8" height="7" alt="" class="left" />
				<img src="/trucking/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
					...
					<tr>
						...
						<td class="last"><input type="text" class="text" id='customerName' name='customerName'/></td>
					</tr>
					<tr class="bg">
						<td class="first"><strong>Phone:</strong></td>
						<td class="last"><input type="text" class="text" id='customerTel' name='customerTel' /></td>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Fax:</strong></td>
						<td class="last"><input type="text" class="text" id='customerFax' name='customerFax'/></td>
					</tr>
					<tr class="bg">
					...
					<tr class="bg">
						...
						<td class="last"><input type="text" class="text" id='customerWebsite' name='customerWebsite' /></td>
					</tr>
					<tr>
			...
			$queryCustomers = "select * from customer order by customerId desc limit 5";
			...
			if($numTerms>0)
			{
				...
				while($term = mysql_fetch_assoc($terms))
				{
					...
					echo "
						...
						<td><a href='/trucking/php/new/newContact.php?i=".$term['customerId']."'><img src='/trucking/img/95.png' width='20' height='20' /></a></td>
						<td><a href='/trucking/php/view/viewCustomer.php?i=".$term['customerId']."'><img src='/trucking/img/16.png' width='20' height='20' /></a></td>
						<td><a href='/trucking/php/edit/editCustomer.php?i=".$term['customerId']."'><img src='/trucking/img/13.png' width='20' height='20' /></a></td>
						<td class='last'><a onclick=\"return confirm('Are you sure you want to delete ".$term['customerName']." and all of its contacts?');\" href='deleteCustomer.php?i=".$term['customerId']."'><img src='/trucking/img/118.png' width='20' height='20' /></a></td>
					</tr>";
				}
