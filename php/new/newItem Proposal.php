...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			...
			$queryContacts = "select * from item_proposal JOIN project USING (projectId) JOIN material USING (materialId) JOIN supplier USING (supplierId) order by itemProposalId desc limit 5";
			...
			if($numTerms>0)
			{
				...
				echo "<tr>
						<th class='first' width='177'>Job</th>
						<th>Material</th>
						<th>Supplier</th>
						<th>Last Edit</th>
						<th>View</th>
				...
				while($term = mysql_fetch_assoc($terms))
				{
					...
					echo "
						<td class='first style2'>".$term['projectId']." - ".$term['projectName']." <a href='/trucking/php/view/viewJob.php?i=".$term['projectId']."'><img src='/trucking/img/16.png' width='12' height='12' /></a></td>
						<td>".$term['materialName']."</td>
						<td>".$term['supplierName']."</td>
						<td>".to_MDY($term['itemProposalCreationDate'])."</td>
						<td><a href='/trucking/php/view/viewItemProposal.php?i=".$term['itemProposalId']."'><img src='/trucking/img/16.png' width='20' height='20' /></a></td>
						<td><a href='/trucking/php/edit/editItemProposal.php?i=".$term['itemProposalId']."'><img src='/trucking/img/13.png' width='20' height='20' /></a></td>
						";
					echo "<td class='last'><a onclick=\"return confirm('Are you sure you want to delete this proposal?');\" href='deleteItemProposal.php?i=".$term['itemProposalId']."'><img src='/trucking/img/118.png' width='20' height='20' /></a></td>";
