...
#################
$title = "Supplier Pay Cheque";
#################
$subtitle = "Supplier Pay Cheque";
$description = "Remove existing pay cheques from this supplier invoice.";
...
###############Next Autoincrement#########
$next_inc=0;
$showstatus="show table status like 'suppliercheque'";
...
function removePayCheque(paidId){
	$.ajax({
		type: "GET",
		url: "removeSupplierPayCheque.php",
		data: "i="+paidId,
...
<div class="top-bar">
			...
			<form id="formValidate" name="formValidate" method="POST" action="submitPayCheque.php" onsubmit="return validateForm();" >
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="4">Pay Cheques available for Supplier Invoice <?echo $reportInfo['supplierInvoiceNumber'];?></th>
					</tr>
					<tr>
						<th>Number</th>
						<th>Date</th>
					...
					while($cheque = mysql_fetch_assoc($cheques)){
						...
						echo "<td><img src='/trucking/img/118.png' width='20' height='20' class='deletable' valor='".$cheque['supplierchequeId']."' /></td>";
						echo "</tr>";
					}
					?>
				</table>
