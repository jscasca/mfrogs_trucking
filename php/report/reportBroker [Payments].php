...
$(document).ready(function()
{
	$('#previewBalanceButton').click(function(){
		...
		$('<iframe />',{
			name: 'framePreview',
			id: 'framePreview',
			src: 'showBrokerPaymentsPreview.php?fromDate='+startDate+'&toDate='+endDate+'&brokerId='+brokerId+'&driverId='+driverId
	...
	$('#printBalanceButton').click(function(){
		...
		var brokerId = $('#brokerId').val();
		var driverId = $('#driverId').val();
		var url = 'showBrokerPaymentsPreview.php?fromDate='+startDate+'&toDate='+endDate+'&brokerId='+brokerId+'&driverId='+driverId;
		...
		<div id="center-column">
			...
			<form id="formValidate" name="formValidate" method="POST" action="submitInvoice.php" onsubmit="return validateForm();" >
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="6">Broker Payments</th>
					</tr>
					<tr class='bg'>
