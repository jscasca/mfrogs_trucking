...
$title = "Report";
#################
$subtitle = "Customer [Cheques]";
$description = "Report customer cheques. Select a customer to review the received cheques in a specific time range.";
...
$(document).ready(function()
{
	...
	$('#previewBalanceButton').click(function(){
		...
		$('#framePreview').remove();
		console.log('showCustomerChequesReport.php?fromDate='+startDate+'&toDate='+endDate+'&customerId='+customerId);
		
		$('<iframe />',{
			name: 'framePreview',
			id: 'framePreview',
			src: 'showCustomerChequesReport.php?fromDate='+startDate+'&toDate='+endDate+'&customerId='+customerId
	...
	$('#printBalanceButton').click(function(){
		...
		var endDate = $('#toDateInput').val();
		var customerId = $('#customerId').val();
		var url = 'showCustomerChequesReport.php?fromDate='+startDate+'&toDate='+endDate+'&customerId='+customerId;
	...
	<div id="middle">
		...
		<div id="center-column">
			...
			<form id="formValidate" name="formValidate" method="POST" action="submitInvoice.php" onsubmit="return validateForm();" >
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="6">Customer Cheques</th>
					</tr>
					<tr class='bg'>
						<td>Payments target</td>
					...
					<tr>
						...
						if($countTerms > 0)
						{
								...
								{
									if(isset($_GET['b'])&&$_GET['b']==$term['customerId'])
